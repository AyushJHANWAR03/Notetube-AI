    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Get summaries, bullet points, and key timestamps automatically
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Test your knowledge with quizzes, flashcards, and interview mode
            </p>
          </div>
          ...
          <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Ask questions and get instant answers from the video content
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center text-sm text-gray-500">
          ...
          <p className="mt-2">Next: Video Processing</p>
        </div>
      </div>
    </main>
  );
